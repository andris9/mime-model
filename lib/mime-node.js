...
class MimeNode {
    ...
    setContentTransferEncoding(encoding, skipAdd) {
    ...
    updateContentDisposition() {
        let contentDispositionHeaders = this.headers.get('Content-Disposition');
    ...
    addHeader(line, pos, replace) {
        ...
        this.headers[replace ? 'replace' : 'insert'](headerLine, pos);
        return headerLine;
    }
