...
class MimeNode {
    ...
    removeLastBr() {
        ...
        if (this.childNodes) {
            ...
            let lastChild = this.childNodes.length > 0 ? this.childNodes[this.childNodes.length - 1] : null;
